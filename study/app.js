...
const addFileBtn    = document.getElementById('study-add-file-btn');
...
const fileWrapper   = document.getElementById('study-file-wrapper');
const filePreview   = document.getElementById('study-file-preview');
const fileIconDisp  = document.getElementById('study-file-icon');
